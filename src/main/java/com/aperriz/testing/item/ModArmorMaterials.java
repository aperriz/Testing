...
public enum ModArmorMaterials implements ArmorMaterial {
    SAPPHIRE("sapphire", 50, new int[]{4, 7, 9, 4}, 17, SoundEvents.ARMOR_EQUIP_IRON, 3.5F, 0.05F, () -> {
        return Ingredient.of(ModItems.SAPPHIRE.get());
    }),
    RUBY("ruby", 50, new int[]{4, 7, 9, 4}, 17, SoundEvents.ARMOR_EQUIP_IRON, 3.5F, 0.05F, () -> {
